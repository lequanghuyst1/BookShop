<template>
  <MDialog id="m-dialog__notice">
    ...
    <template v-if="isBtnCancel" #footer>
      <MButton @click="onBtnCancel" class="m-button--sub" text="Hủy"></MButton>
      <MButton @click="onBtnConfirm" text="Xác nhận"></MButton>
    </template>
    <template v-else #footer>
      <MButton @click="onBtnCorrect" text="Xác nhận"></MButton>
    </template>
  </MDialog>
</template>
<script>
