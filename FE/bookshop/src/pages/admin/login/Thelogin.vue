    ...
    methods: {
      ...
      validateFormLogin() {
        if (
          ...
          this.errorList.Email = this.$Resource[this.$languageCode].Text.UsernameLoginNotEmpty;
        ...
        if (
          ...
          this.errorList.Password =  this.$Resource[this.$languageCode].Text.PasswordLoginNotEmpty;
          this.isCheckLogin = false;
        } else {
