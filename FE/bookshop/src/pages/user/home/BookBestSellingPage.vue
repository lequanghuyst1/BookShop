          ...
          >
            ...
            >
              <span
                ...
                ><span itemprop="name">Sách bán chạy</span></span
              >
        ...
        <div class="col-9">
          <div class="category-tab-product">
            <div class="tab-content">
              <div
                v-if="
                  this.filterData.rangeColumn.length > 1 ||
              ...
              >
                <ul>
                  ...
                  <li
                    v-for="(item, index) in this.filterData.rangeColumn.slice(
                      1
                    )"
                    :key="index"
                  >
  ...
  data() {
    return {
      ...
      filterData: {
        ...
        rangeColumn: [
          { ColumnName: "QuantitySold", MinValue: 1, MaxValue: 1000000 },
        ],
        filterInput: [],
      },
