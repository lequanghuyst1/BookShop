...
{
    [ApiController]
    public class ProductReviewsController : MBaseController<ProductReview, ProductReviewDto>
    {
        IProductReviewService _productReviewService;

        #region Constructor
        public ProductReviewsController(IProductReviewService productReviewService) : base(productReviewService)
        {
